...
Script Doc Generator 是 Odin Toolkits For Unity 的核心模块之一，用于快捷生成代码注释文档。

### 核心特性

- 支持单个类型、多个类型或整个程序集的文档批量生成。
- 支持脚本文档增量生成，默认保留文档中 “## 额外说明” 后的内容，不覆盖生成。
- 支持分析源代码中声明的类，以及类包含的构造函数、方法、事件、属性、字段。
